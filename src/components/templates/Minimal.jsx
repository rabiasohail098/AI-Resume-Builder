...
//   const { form, experience, education, skills, projects, languages, certifications } = data;

//   return (
//     <div className="minimal-template">
//       {/* Header */}
//       <header className="mb-8 text-center">
//         <h1 className="text-3xl font-light mb-2 tracking-wide">{form.fullName}</h1>
...
//           <p className="text-center italic text-gray-600">{form.summary}</p>
//         </section>
//       )}
...
//                   {project.link && (
//                     <a href={project.link} className="text-sm text-gray-500 hover:underline">View</a>
//                   )}
//                 </div>
//                 <p className="text-sm text-gray-600 mb-1">{project.description}</p>
//                 {project.tech && (
//                   <p className="text-xs text-gray-500">Tech: {project.tech}</p>
//                 )}
//               </div>
//             ))}
//           </section>
